...
from edgencechain.helpers import (_chunks,  deserialize,
                                  get_merkle_root_of_txns, serialize, sha256d)
from edgencechain.params import Params
from edgencechain.wallet import init_wallet, pubkey_to_address
...
def load_from_disk():
    ...
    try:
        with open(CHAIN_PATH, "rb") as f:
            ...
            logger.info(
                f"loading chain from disk with {len(new_blocks)} blocks")
